...
const Chat = () => {
  ...
  return (
    <div className="message-page__left">
      <Link to="/" className="message-page__left--back">
      ...
      <div className="message-page__left--chat">
        <div className="message-page__left--chat--header">
          ...
          <div className="header-text">
            <p className="header-text--name">2008 Mazdar 3 3000miles</p>
        ...
        <div className="chat-container">
          <ul id="messages" className="messages-box">
            {messages.map((msg, index) => (
              <li
                key={index}
                className={`message ${
                  msg.userId === userId ? "sender" : "receiver"
                }`}
              >
                {msg.text}
              </li>
          ...
          <form onSubmit={sendMessage}>
            <input
              ...
              autoComplete="off"
              onKeyPressdown={(e) => e.key === "Enter" && sendMessage(e)}
            />
          </form>
        </div>
      </div>
